...
<style>
  div.quarto-figure:not(.column-screen) {
    padding-right: 2em;
  }
...
<div class='cell'><details open>
<summary>`gcloud container clusters get-credentials my-autopilot-cluster --location=us-east1`</summary>
...
<summary>`kubectl apply -f ./release/kubernetes-manifests.yaml`</summary>
...
![Kubernetes Cluster VS Code extension view](kube-vs-code-ext.png){#fig-kube-vs-code-ext height=600 fig-align="left"}
...
- `Resource Management -> Workloads -> frontend -> Exposing services -> frontend-external -> Endpoints`
...
<div class='cell'><details>
<summary>`kubectl scale --replicas=3 deployment/frontend`</summary>
```{.bash}
...
![Frontend Deployment of 3 Replicas](kube-vs-code-replicas.png){#fig-kube-vs-code-replicas height=415 fig-align="left"}
...
<div class='cell'><details>
<summary>`kubectl scale --replicas=1 deployment/frontend`</summary>
```{.bash}
deployment.apps/frontend scaled
```
</details></div>
...
<div class='cell'><details>
<summary>`kubectl autoscale deployment/frontend --cpu-percent 5 --min 1 --max 3`</summary>
```{.bash}
...
<div class='cell'><details>
<summary>`kubectl scale deployment/loadgenerator --replicas 5`</summary>
```{.bash}
...
![Horizontal Autoscaling of Frontend Deployment](kube-vs-code-hpa.png){#fig-kube-vs-code-hpa height=502 fig-align="left"}
...
<div class='cell'><details>
<summary>`gcloud container clusters delete my-autopilot-cluster --region us-east1`</summary>
